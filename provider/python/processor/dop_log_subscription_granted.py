...
"params":
    ...
    "event_set": [{"event_id": "LogSubscriptionGranted", "data":
...
class LogSubscriptionGrantedProcessor(ProcessorProvider): 
    ...
    def __init__(self):
        ...
        self._event_id_content = "LogSubscriptionGranted"
        self._trigger_event = "dop_subscription_grant"
